      ...
      <div className="container px-4 mx-auto">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
            Your Growth Starts Here — Let's Chat
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Ready to transform your brand's digital presence? Get in touch and let's discuss how we can help you achieve
            your goals.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-8">
                ...
                <CardContent className="p-0">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:sonaliguha1812@gmail.com" className="text-yellow-500 hover:underline font-medium">
                ...
                <CardContent className="p-0">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-2">Stay updated with our latest content</p>
                      <a
            ...
            <div className="p-6 bg-gradient-to-br from-yellow-500/10 to-orange-500/10 rounded-lg border border-yellow-500/20">
              <h3 className="text-xl font-semibold mb-4">At OptiReach, we blend creativity with strategy</h3>
