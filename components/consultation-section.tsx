          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                1:1 Strategy Consulting to <span className="text-yellow-500">Accelerate Business Growth</span>
              </h2>
              <p className="text-xl text-muted-foreground">
                Unlock clarity, direction, and results with expert-led strategy sessions tailored to your brand.
              </p>
            </div>

            <div className="space-y-6">
              <p className="text-lg leading-relaxed">
                I help businesses craft high-converting marketing strategies, elevate their digital presence, and drive
                measurable growth—one focused session at a time.
              </p>
              <p className="text-lg leading-relaxed font-semibold">Let's turn insight into action.</p>
            </div>
              ...
              <Card className="p-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-0">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-semibold">60-Minute Strategy Sessions</span>
                  </div>
                </CardContent>
              </Card>
              <Card className="p-4 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-green-500/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-0">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-semibold">Personalized Action Plan</span>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-8 hover:shadow-2xl transition-all duration-500">
              <div className="h-full w-full rounded-xl bg-background/80 backdrop-blur-sm border flex flex-col items-center justify-center space-y-6 p-8">
                ...
                <h3 className="text-2xl font-bold text-center">Strategy Session Preview</h3>
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  <div className="text-center p-3 bg-yellow-500/10 rounded-lg">
                    <div className="text-2xl font-bold text-yellow-500">60min</div>
